...
import { GraduationCap, Mail, Lock, Eye, EyeOff, Sun, Moon } from "lucide-react";
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-12 bg-gradient-to-br from-violet-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/30">
              <GraduationCap size={24} className="text-white" />
            </div>
            <div>
              <h1 className="text-2xl font-black text-gray-900 dark:text-white">EduFlow</h1>
          ...
          <h2 className="text-4xl font-black text-gray-900 dark:text-white leading-tight mb-4">
            Learn, Grow, <span className="text-violet-600">Succeed</span>
          </h2>
          <p className="text-gray-500 dark:text-gray-400 mb-8">Join thousands of students learning new skills every day.</p>

          <div className="space-y-3">
            {[
              { icon: "📚", title: "100+ Courses", desc: "Wide range of topics" },
              { icon: "🏆", title: "Certificates", desc: "Earn on completion" },
              { icon: "👨‍🏫", title: "Expert Teachers", desc: "Learn from the best" },
              { icon: "📱", title: "Learn Anywhere", desc: "Mobile friendly" },
            ].map((f) => (
              <div key={f.title} className="flex items-center gap-3 p-3 bg-white/60 dark:bg-white/5 backdrop-blur rounded-2xl border border-gray-100 dark:border-white/10">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-100 dark:border-white/10 p-8">
          <div className="lg:hidden flex items-center gap-3 mb-6">
            ...
            <h1 className="text-xl font-black text-gray-900 dark:text-white">EduFlow</h1>
          </div>
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-5">
            ...
            <Link href="/register" className="text-violet-600 font-bold no-underline hover:text-violet-700">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
